...
<img src="https://via.placeholder.com/800x450/1a1a1a/ffffff?text=3D+Bear+Character+in+Action" alt="Gameplay Screenshot" width="100%"/>

<p><em>Interactive 3D bear character navigating the sandbox world</em></p>

<h3>🌅 Dynamic Lighting System</h3>
<img src="https://via.placeholder.com/800x450/87CEEB/ffffff?text=Dynamic+Sun+%26+Shadows" alt="Lighting Demo" width="100%"/>

<p><em>Real-time sun movement with dynamic shadows and lens flare effects</em></p>

<h3>🏗️ Block Building Mechanics</h3>
<img src="https://via.placeholder.com/800x450/228B22/ffffff?text=Block+Placement+%26+Destruction" alt="Building System" width="100%"/>
...
<h3>👨‍💻 <strong>Bernardo</strong> - <em>Computer Science Student at Universitas Diponegoro</em></h3>
...
<p>
<strong>📧 Email:</strong> <code>your.email@example.com</code><br/>
<strong>🏫 University:</strong> Universitas Diponegoro - Information Technology<br/>
<strong>📍 Location:</strong> Semarang, Central Java, Indonesia
</p>
...
<h3>🌟 <strong>If this project impressed you, please consider giving it a star!</strong> ⭐</h3>

<p><strong>Made with ❤️ and lots of ☕ by Bernardo</strong></p>

<p><em>Showcasing the intersection of creativity, technology, and innovation</em></p>
...
bool checkCollision(float x, float y, float z) {
    ...
    // Prevents character from passing through blocks
}
```

<p><strong>🎨 Shadow Projection Algorithm:</strong></p>

```cpp
void glShadowProjection(float* groundPlane, float* lightPos) {
    // Real-time shadow matrix calculation
    // Projects 3D objects onto ground plane
}
```

<p><strong>⚡ Performance Optimizations:</strong></p>
<ul>
<li>Matrix transformation caching with <code>glPushMatrix()/glPopMatrix()</code></li>
<li>Efficient vertex buffer management</li>
<li>Optimized rendering pipeline for smooth 60+ FPS</li>
</ul>
